...
//static component represents privacy policy
//imported at App as const, not as component
export const Privacy= (
	<>
		...
		<p>
			...
			provide in the &quot;JSON Translation Tool&quot; web application (&quot;Web
			Application&quot; or &quot;Service&quot;) and any of its related
			...
			this Web Application developer (&quot;Operator&quot;, &quot;we&quot;,
			&quot;us&quot; or &quot;our&quot;). By accessing and using the Web
		...
		<p>
			...
			it is absolutely necessary to maintain the Web Application and
			...
			the usage of the Web Application and Services. This statistical
			information is not otherwise aggregated in such a way that would
			identify any particular user of the system.
		</p>
		<h2>Collection of personal information</h2>
		<p>
			You can access and use the Web Application and Services without
			...
			you wish to use some of the features in the Web Application, you may
			be asked to provide certain Personal Information (for example, your name
			and e-mail address). We receive and store any information you knowingly
			provide to us when you fill any online forms in the Web Application.
		...
		<ul>
			...
			<li>Google API key that you provide to us.</li>
			<li>
				Web Application usage statistics associated with your account.
			</li>
		</ul>
		<h2>Use and processing of collected information</h2>
		<p>
			In order to make the Web Application and Services available to you,
			...
			or services. Any of the information we collect from you may be used only 
			to run and operate the Web Application and Services.
		</p>
		<p>
			Processing your Personal Information depends on how you interact with
			the Web Application and Services, where you are located in the world
			and if one of the following applies: (i) you have given your consent for
			one or more specific purposes; this, however, does not apply, whenever
			the processing of Personal Information is subject to California Consumer
		...
		<p>
			...
			the operation of the Web Application and Services available to you.
			...
			consistent with ours or who agree to abide by our policies with respect
			to Personal Information. These third parties are given Personal
		...
		<p>
			...
			Personal Information through the Web Application and Services. We
			...
			children never to provide Personal Information through the Web
			Application and Services without their permission. If you have reason to
			believe that a child under the age of 18 has provided Personal
			Information to us through the Web Application and Services, please
		...
		<p>
			The Web Application and Services contain links to other resources
			...
			parties. We encourage you to be aware when you leave the Web
		...
		<p>
			...
			exchanged between you and the Web Application and Services cannot be
		...
		<h2>Data breach</h2>
		<p>
			In the event we become aware that the security of the Web Application
		...
		<p>
			...
			Web Application and Services from time to time in our discretion and
			will notify you of any material changes to the way in which we treat
			Personal Information. When we do, we will revise the updated date at the
			bottom of this page. We may also provide notice to you in other ways in
			...
			continued use of the Web Application and Services after the effective
			date of the revised Policy (or such other act specified at that time)
		...
		<p>
			...
			terms and conditions. By accessing and using the Web Application and
			...
			use the Web Application and Services.
		</p>
		<p style={{ textAlign: "end", color: "darkblue" }}>
			This document was last updated on May 03, 2021
		</p>
	</div>
	</>
)